...
@section('noidung')
    <div class=" alert alert-info">
                ...
                @endif
                     ...
                     <h3> <span style='color:green'>{{ucwords(Auth::user()->name)}}</span> , thông tin</span></h3>
                     {!! Form::open(['url' => 'updateAddress' , 'method' =>'post']) !!} 
                      
                        <div class="form-group row">
                          
                          <div class="form-group col-md-6">
                          <label for="example-text-input">Họ tên</label>
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group col-md-6">
                          <label for="example-text-input">Địa chỉ </label>
                         ...
                         <div class="form-group row">
                          ...
                          <div class="form-group col-md-6">
                          <label for="example-text-input">Số điện thoại</label>
