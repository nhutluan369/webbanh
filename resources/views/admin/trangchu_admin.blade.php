...
{{-- <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			 --}}
		...
		<div class="row">
			<div class="col-lg-12">
                <h2>Chào mừng <span style="color:red"> {{Auth::user()->name}}</span> đến với trang quản trị</h2>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{count($dsdonhang)}}</div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">{{count($spmoi)}}</div>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">Tài khoản user</div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							...
							<div class="text-muted">Lượt xem trang</div>
						</div>
					</div>
				</div>
			</div>
