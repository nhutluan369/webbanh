...
<title>Đăng nhập admin|Tuấn Thắng Bakery</title>
                    ...
                    <div id="section-box">
                        ...
                        @endif --}}
                            ...
                            <fieldset class="loginform">
                                ...
                                <label for="login-password" id="login-password-lbl">Mật khẩu</label>
                                <input type="password" size="15" class="inputbox" id="login-password" name="password">
                                <div class="button-holder">
                                    <div class="button1">
                                        <div class="next">
                                            <input class="btndangnhap" type="submit" name="dangnhap" id="dangnhap" value="Đăng nhập">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
