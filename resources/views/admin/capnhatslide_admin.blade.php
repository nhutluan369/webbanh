                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input placeholder="Đường dẫn đến trang liên kết" name="link" type="text">
                                </td>
                            </tr>
                        ...
                        <div class="ds_button_admin">
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/danh-sach-slide-banner';">Hủy thao tác</div>
