                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            <tbody><tr>
                                ...
                                <td>
                                    <input required="required" placeholder="Tên loại sản phẩm" name="ten_loai_san_pham" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <div class="ds_button_admin">
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/danh-sach-loai-san-pham';">Quay lại</div>
