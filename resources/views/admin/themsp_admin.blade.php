                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::textarea('mo_ta', null,
                                        array('id'=>'mo_ta', 'placeholder'=>'Mô tả tóm tắt','required')) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="ipdongia" required="required" placeholder="Đơn giá" name="don_gia" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                   <p id="dv"> Đơn vị tính(*): </p>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                     <input id="size" required="required" placeholder="Size lớn" name="size1" type="hidden">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                     <input id="gia" required="required" placeholder="Giá" name="gia1" type="hidden">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                     <input  placeholder="Size vừa" name="size2" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                     <input  placeholder="Giá" name="gia2" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <div class="ds_button_admin">
                            <input class="btn_luu" type="button" value="Nhập giá theo size" onclick="window.location.href='{{route('themsanphamsize')}}'">
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/danh-sach-san-pham';">Quay lại</div>
