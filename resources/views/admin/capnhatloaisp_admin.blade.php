                    ...
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <table class="form_cap_nhat">
                            <tbody><tr>
                                ...
                                <td>
                                    <input required="required" placeholder="Tên loại sản phẩm" name="ten_loai_san_pham" value="{{$thongtinloaisp->name}}" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::textarea('mo_ta', $thongtinloaisp->intro,
                                        array('required','id'=>'mo_ta', 'placeholder'=>'Mô tả tóm tắt','required')) !!}
                        ...
                        <div class="ds_button_admin">
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/danh-sach-loai-san-pham';">Hủy thao tác</div>
