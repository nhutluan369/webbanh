...
<div class="main_form_admin">
                ...
                {{-- <div class="div_danh_sach_items">
                    ...
                    <input class="btn_password" type="submit" value="Đổi mật khẩu">
                    <input id="sua" class="btn_sua" type="submit" onclick="Sua()" value="Sửa">
                    <input id="sua" class="btn_luu" type="submit" value="Lưu">
                    <div class="clear"></div>
            ...
            {!! Form::open(array('route'=>'postthongtintaikhoan','id'=>'form_cap_nhat_san_pham','class' => 'form_cap_nhat_san_pham', 'files'=>true)) !!}
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        <div class="ds_button_admin">
                            <div class="btn_xoa" onclick="window.location='{{url('/')}}/admin/thong-tin-tai-khoan/doi-mat-khau';">Đổi mật khẩu</div>
