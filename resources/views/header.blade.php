						...
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								 @if(Auth::check())
									...
									<li><a style="color: white" href="{{ route('dangxuat')}}"><i style="color: white" class="glyphicon glyphicon-share"></i>Đăng xuất</a></li>
								@else
									<li><a style="color: white" href="{{route('dangki')}}"><i style="color: white" class="fa fa-user"></i>Đăng kí</a></li>
									<li><a style="color: white" href="{{route('dangnhap')}}"><i  style="color: white" class="fa fa-user"></i>Đăng nhập</a></li>
								@endif
							</ul>
						</div>
							...
							<ul class="nav navbar-nav">
								...
								<li><a style="color: white; background:none; font-weight: bold;"  href="{{url('/')}}/WishList"><img title="Đã yêu thích" width="20px" style="cursor: pointer" src="{{url('/')}}/source/images/home/loved2.png">Yêu thích<span  style="color: white; font-weight: bold;">( {{App\wishList::where('user_id',Auth::user()->id)->count()}})</span></a></li>
					...
					<div class="col-sm-5" style="padding-top: 5px">
						<div  class="search_box pull-right">
							<form  action='{{route('search')}}' method="post" >
								<input style="height:35px; width:500px; background-color: #fff; opacity: 0.5;border: 1px solid #bdb3b3;border-radius: 5px;" type="text" name="search_data" id="proList" placeholder="Tìm kiếm sản phẩm, loại sản phẩm bạn mong muốn"  id="proList" />
					                ...
					                ?>
						                ...
						                <div class="col-md-12" >
							                  		...
							                  		<div class="col-md-7">
							                  			...
							                  			<p>Giá: {{$cartID->price}}</br> Số lượng: {{$cartID->qty}}</p>
							                  		</div>
						                 </div>
						                 @endforeach
						                 <br><br>
						                 ...
						                 <div class="row">
						                 	...
						                 	<a href="{{url('checkout')}}" style="padding: 5px; color: #fff ; background-color: orange" class="btn btn-primary">Thanh toán</a>
						                 	</div>

						                 	<div class="col-md-5 pull-right">
						                 	<a href="{{url('gio-hang')}}" style="padding: 5px; color: #fff ; background-color: blueviolet" class="btn btn-info">Giỏ hàng</a>
						                 	</div>
