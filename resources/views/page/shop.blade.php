  		...
  		$('#cartBtn<?php echo $i; ?>').click(function(){
  			...
  			$.ajax({
  				...
  				success:function(){
  					...
  					$('#successMsg<?php echo $i; ?>').append('san pham da duoc them vao gio hang');
  				}
  			});
  		});
  		<?php } ?>
			...
			<div class="row">
				...
				<div class="price-range"><!--price-range-->
                                <div style="background: none" class="well">
                                   <h2>Mức GIÁ VNĐ</h2>
                                    ...
                                    <br>
                                    <b class="pull-left">
                                        <input size="4" type="text" id="amount_start" name="start_price"
                                               value="75.000" style="border:0px; font-weight: bold; color:green;background: none;" readonly="readonly" /></b>
                                    <b class="pull-right">
                                        <input size="4" type="text" id="amount_end" name="end_price" value="350.000"
                                               style="border:0px; font-weight: bold; color:green;background: none" readonly="readonly"/></b>
                                   </div>
                            </div><!--/price-range-->

						
						<div class="shipping text-center"><!--shipping-->
							<div class="fb-page" data-href="https://www.facebook.com/Tu&#x1ea5;n-Th&#x1eaf;ng-Bakery-307549689685452/" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Tu&#x1ea5;n-Th&#x1eaf;ng-Bakery-307549689685452/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Tu&#x1ea5;n-Th&#x1eaf;ng-Bakery-307549689685452/">Tuấn Thắng Bakery</a></blockquote></div>
						</div><!--/shipping-->
				...
				<div class="col-sm-9 padding-right" id="updateDiv" >
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center"> <span style="color: orange; font-weight: bold;">Danh sách sản phẩm </span> </h2>
						<?php $countP = 0;  ?>
							...
							<div class="product-image-wrapper" style="box-shadow: 2px 4px 2px 0px #bbb;">
								<div class="single-products">
										<div class="productinfo text-center" >
											...
											<a href="gio-hang/addItem/{{$sl->id}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Giỏ Hàng</a>
										</div>
								...
								<?php } else {?>
									...
									{{-- <h5 align="center" style="color: green"> Đã Thêm vào mục <a href="{{url('WishList')}}">yêu thích</a></h5>  --}}
								<?php } ?>
								</div>
