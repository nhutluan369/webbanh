			...
			<div class="row">
				...
				<div class="col-sm-12 padding-right">
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center"> <span style="color: orange; font-weight: bold;">Sản phẩm mới </span> </h2>
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center"> <span style="color: orange; font-weight: bold;">Top sản phẩm bán chạy </span> </h2>
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center"> <span style="color: orange; font-weight: bold;">Top sản phẩm được yêu thích </span> </h2>
